...
{
    public class OverseaExpenditureClaimLogMap : EntityTypeConfiguration<OverseaExpenditureClaimLog>
    {
        public OverseaExpenditureClaimLogMap()
        {
            ToTable("oa_wfsLog_claim_OverseaExpenditureLogs");

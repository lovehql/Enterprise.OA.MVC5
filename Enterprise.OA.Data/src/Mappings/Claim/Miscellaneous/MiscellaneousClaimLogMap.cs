...
{
    public class MiscellaneousClaimLogMap : EntityTypeConfiguration<MiscellaneousClaimLog>
    {
        public MiscellaneousClaimLogMap()
        {
            ToTable("oa_wfsLog_claim_MiscellaneousLogs");

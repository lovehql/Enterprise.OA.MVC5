...
{
    public class EntertainmentClaimLogMap : EntityTypeConfiguration<EntertainmentClaimLog>
    {
        public EntertainmentClaimLogMap()
        {
            ToTable("oa_wfsLog_claim_EntertainmentLogs");
